...
A isto chama"-se o esforço para vencer.
...
Ele está ciente quando estes obstáculos estão ausentes em si: “Estes obstáculos
...
A vigilância na inspiração e expiração, assim praticada e desenvolvida, conduz
...
\begin{quote}
  ...
  \emph{Vism. VIII, 145ff.}) e pelos dez exercícios"-kasina (\emph{Vism. IV, V},
  ...
  (\emph{muditā}) constitui a prática dos três primeiros \emph{brahma"-vihāras}
  (\emph{Vism. IX, 1ff.}).
  ...
  Buddha, Dhamma, e Sangha; da moralidade, a libertação, os seres
...
hábito amarelo e parte da vida do lar para a vida sem lar mendicante.
...
que se dirigem ao coração com cortesia, amigáveis e agradáveis a todos.
...
e não come a horas indevidas. Mantém"-se afastado da dança, das cantigas, da
...
Não aceita ouro nem prata. Não aceita milho cru nem carne crua, nem mulheres nem
moças, escravos ou escravas, cabras, ovelhas, galinhas, porcos, elefantes,
...
diante e para trás; ao dobrar e esticar os membros; ao vestir os hábitos e a
transportar a gamela; ao comer, beber, mastigar e saborear; ao defecar e urinar;
ao andar e permanecer de pé, sentado, ao adormecer e ao acordar; ao falar e ao
manter silêncio.
...
compreensão lúcida (\emph{sati"-sampajañña}), ele escolhe um local retirado na
...
Livrou"-se da má"-fé (\emph{vyāpāda}); mantém"-se com um coração livre de
má"-fé; acalentando amor e compaixão para com todos os seres vivos, retira do
seu coração a má"-fé.
...
(\emph{anicca}), sujeitos à dor (\emph{dukkha}), como uma enfermidade, uma
...
Assim, o objectivo da vida pura não consiste em adquirir riqueza, honra,
fama, nem ganhar moralidade, concentração ou a visão do conhecimento. Sem
