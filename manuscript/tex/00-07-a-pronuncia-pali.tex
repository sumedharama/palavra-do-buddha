...
\emph{a} & (curto) Em Português é pronunciado como \emph{a} mudo em \emph{par\prul{a}} ou \emph{c\prul{a}nec\prul{a}}.\\

\emph{ā} & (longo) \emph{j\prul{á}, tom\prul{a}r, c\prul{a}sa, m\prul{a}la, \prul{á}gua}\\

\emph{e} & \emph{p\prul{ê}ra, m\prul{e}sa, m\prul{ê}s}\\

\emph{i} & (curto) \emph{v\prul{i}da, l\prul{i}vro, f\prul{i}lho}\\

\emph{ī} & (longo) \emph{Mar\prul{i}a, melanc\prul{i}a}\\

\emph{o} & \emph{av\prul{ô}, b\prul{o}lo, fl\prul{o}r}\\

\emph{u} & (curto) \emph{p\prul{u}reza, m\prul{u}ndo}\\

\emph{ū} & (longo) \emph{m\prul{ú}sica, d\prul{ú}vida}\\
\end{tabular}
