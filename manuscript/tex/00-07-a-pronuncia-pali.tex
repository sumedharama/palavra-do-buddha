...
\emph{ā} & \emph{j\prul{á}, tom\prul{a}r, c\prul{a}sa, m\prul{a}la, \prul{á}gua}\\

\emph{e} & \emph{p\prul{ê}ra, m\prul{e}sa, m\prul{ê}s}\\

\emph{i} & \emph{v\prul{i}da, l\prul{i}vro, f\prul{i}lho}\\

\emph{ī} & \emph{Mar\prul{i}a, melanc\prul{i}a}\\

\emph{o} & \emph{av\prul{ô}, b\prul{o}lo, fl\prul{o}r}\\

\emph{u} & \emph{p\prul{u}reza, m\prul{u}ndo}\\

\emph{ū} & \emph{m\prul{ú}sica, d\prul{ú}vida}\\
\end{tabular}
...
\emph{s} & Sempre como em \emph{\prul{s}ublimar} ou em \emph{\prul{s}e}; nunca como \emph{z}, ex: em \emph{causar} ou em \emph{físico}.\\
